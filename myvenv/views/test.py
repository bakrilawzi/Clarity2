...
# # x = virtualpainter(folderPath=folderPath)
# # while x.cap.isOpened():
# #     frame   = x.open_camera()
# #     fing= x.detection_fingers()
# #     x.selection_mode(fing,frame)
# #     x.endin_app(frame)
# #     x.releasing()
...
import os 
import pathlib
print(os.path.abspath("myvenv/models/utils/Database.py"))
print(os.path.abspath(".../myvenv"))